...
```lean
theorem JSP001017.jsp_001017_literal : HasLiteralInfinitePath
```
...
Lean is pinned in `lean-toolchain`; Mathlib is pinned to commit `db584cd6d46c92f209a44c0f1c829460d327499d`.

The root module runs:

```lean
#print axioms JSP001017.jsp_001017_literal
```
